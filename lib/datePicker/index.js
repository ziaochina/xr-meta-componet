...
function Comp(props) {
	return _react2.default.createElement(_xrComponent.DatePicker, (0, _extends3.default)({}, props, { value: (0, _moment2.default)(props.value, props.format), onChange: handleChange(props) }));
}
